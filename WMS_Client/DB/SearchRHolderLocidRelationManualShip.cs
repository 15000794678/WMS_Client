...
{
    public class SearchRHolderLocidRelationShipManual : BaseDbQuery
    {
        private DataTable _dt = new DataTable();

        public SearchRHolderLocidRelationShipManual(Dictionary<string,object> dic)
            : base(
                "Select holder_id, loc_id, max_qty, on_qty, material_no, date_code from r_holder_locid_relationship_manual_buffer ",
                DbName)
        {
