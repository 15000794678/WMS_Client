...
namespace Phicomm_WMS.DB
{
    ...
    /// 根据ip获取当前设备的名称和类型
    /// </summary>
    public class SearchInventoryCheckByLocId : BaseDbQuery
    {
        private DataTable _dt = new DataTable();

        public SearchInventoryCheckByLocId(Dictionary<string, object> dic)
            : base(
                "Select check_date, loc_id, plant, stock_id, status from inventorycheckbylocid ", DbName)
        {
