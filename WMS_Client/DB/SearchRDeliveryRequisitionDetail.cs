...
{
    public class SearchRDeliveryRequisitionDetail : BaseDbQuery
    {
        private DataTable _dt = new DataTable();

        public SearchRDeliveryRequisitionDetail(string woid)
            : base(
                "Select woid, material_no, qty, send_qty, PLANT, STORE_LOC, MOVE_TYPE, MOVE_PLANT, MOVE_STLOC, STATUS, sub_type, ID From r_delivery_requisition_detail Where woid='" + woid + "'",
                DbName)
        {
