...
{
    public class CompletePickMaterialByLocId : BaseDbStoredProcedureCaller
    {
        private int _result = -99;
        //private List<string> _listTrSn = new List<string>();

        public CompletePickMaterialByLocId(int stationId, string stockOutNo, string locId, int stockouttype)
            : base(DbName, "P_CompletePickMaterialByLocId",
