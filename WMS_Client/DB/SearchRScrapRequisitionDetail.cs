...
{
    class SearchRScrapRequisitionDetail : BaseDbQuery
    {
        private DataTable _dt = new DataTable();

        public SearchRScrapRequisitionDetail(string woid)
            : base(
                "Select woid, material_no, qty, send_qty, status, sub_type, kpdesc, id, status from r_scrap_requisition_detail where woid='" + woid + "'",
                DbName)
        {
