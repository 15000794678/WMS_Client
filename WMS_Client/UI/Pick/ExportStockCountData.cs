...
{
    public partial class ExportStockCountData : Office2007Form
    {
        public ExportStockCountData()
        {
            InitializeComponent();
        }
        ...
        {            
            ...
            //    string.IsNullOrEmpty(textBox_user.Text.Trim()))
            //{
            //    MessageBox.Show("日期或者用户至少设置一个查询条件!");
            //    return;
            //}
